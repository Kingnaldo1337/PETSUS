...
FILTER_WIDGET_KEYS = (
    ...
    "filter_sexo",
    "filter_faixa_etaria",
    "filter_condicao_clinica",
    "filter_sus_exclusivo",
    "filter_renda_familiar",
    "filter_regiao",
    "filter_uf",
    "filter_municipio",
    "filter_natureza",
    "filter_tipo_demanda",
    "filter_item_demandado",
    "filter_especialidade",
    "filter_esfera",
    "filter_fase_processual",
    "filter_desfecho",
    "filter_liminar",
    "filter_urgente",
    "filter_etapa_judicial",
    "filter_etapa_saude",
    "filter_status_andamento",
    "filter_indicador_atraso",
    "filter_medicamento_dcb",
    "filter_cid",
    "filter_rename_incorporado",
    "filter_componente_sus",
    "filter_grupo_sus",
    "filter_pcdt_aplicavel",
    "filter_pcdt_referencia",
    "filter_competencia_petsus",
    "filter_reu_sugerido",
)
